...
On the contrary, the only reason why we chose this example is to provide a simple application of the `data.tree` package, in order to demonstrate how easy it is to build hierarchical models with it.
