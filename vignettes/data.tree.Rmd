...
```
The `format` function is not only usefule for formatting numbers, but also to display a printable representation of a node field that is not a number (but e.g. a `matrix`)
