...
1. Creating a `Node` is relatively expensive. `CreateRegularTree(6, 6)` creates a data.tree structure with 9331 `Nodes`. On my computer (a mid-end Notebook), this takes about 3 seconds.
