...
```{r}
acme$Do(SetExpectedCost, variableName = "expectedCost", traversal = "post-order")
Sort(acme, "expectedCost", decreasing = TRUE)
...
```{r}
acmeList2 <- acme$ToList(mode = "explicit", nameName = 'id', childrenName = 'subNodes')
...
```{r}
acmeList3 <- acme$ToList(mode = "explicit", unname = TRUE)
