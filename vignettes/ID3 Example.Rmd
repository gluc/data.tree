...
```{r}
tble <- table(mushrooms[,c('color', 'edible')])
tble
informationGain(tble)
informationGain(table(mushrooms[,c('size', 'edible')]))
informationGain(table(mushrooms[,c('points', 'edible')]))
```
