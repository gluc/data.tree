...
data.tree does not provide its own plotting facility, but there are plenty of options for plotting.
...
This is another option. First, we give each `Node` a unique id:
...
You'll learn how data.tree can be used to build a tree of game history, and how the resulting data.tree structure can
